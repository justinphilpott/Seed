...
- `skills/` directory is present with seed-feedback.md, doc-health-check.md, seed-ux-eval.md
...
### Skills Check
[Whether seed-ux-eval.md is present in skills/ — it should be installed alongside seed-feedback]
...
- **Do**: Check skills/ matches what's embedded (seed-ux-eval.md should be present)
